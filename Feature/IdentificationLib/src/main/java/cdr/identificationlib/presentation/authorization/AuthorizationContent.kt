...
import cdr.identificationlib.models.presentation.AuthorizationScreen
import cdr.identificationlib.models.presentation.AuthorizationState
        ...
        Column(
            ...
            Column {
                ...
                Blueberry(
                    ...
                    onClick = { viewModel.signIn(onLaunchMainScreen) }
                )
            }
        }
    }
